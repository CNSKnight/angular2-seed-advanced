...
export function main() {
  t.describe('core.framework: ViewBrokerService', () => {
    ...
    t.it('TEMPLATE_URL: web', () => {   
      ...
      t.e(ViewBrokerService.TEMPLATE_URL('./app/comps-proj/home/home.html')).toBe('./app/comps-proj/home/home.html');
    });
    t.it('TEMPLATE_URL: mobile_native', () => {
      CoreConfigService.PLATFORM_TARGET = CoreConfigService.PLATFORMS.MOBILE_NATIVE;
      t.e(ViewBrokerService.TEMPLATE_URL('./app/comps-proj/home/home.html')).toBe('./app/comps-proj/home/home.tns.html');
    });
